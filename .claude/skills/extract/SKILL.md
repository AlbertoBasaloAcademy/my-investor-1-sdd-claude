...
3. **Container code rules**: fill `container.rules.template.md`, scoped to this container's source glob — naming, artifact roles, conventions, and one canonical example.
